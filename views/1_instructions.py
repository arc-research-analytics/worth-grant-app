...
st.markdown(f'''
    <p style="font-size: 23px; font-weight: 200; text-align: left;">
        ...
        Keep the former file for your records, but return the latter file to Kaela Hammond at <a href="mailto:kaela.hammond@cfgreateratlanta.org?subject=Question%20re%3A%20validator%20app">kaela.hammond@cfgreateratlanta.org</a>, Brandon Davis at <a href="mailto:brandon.davis@cfgreateratlanta.org?subject=Question%20re%3A%20validator%20app">brandon.davis@cfgreateratlanta.org</a>, and Will Wright at <a href="mailto:wwright@atlantaregional.org?subject=Question%20re%3A%20validator%20app">wwright@atlantaregional.org</a>.
    </p>
''', unsafe_allow_html=True)
