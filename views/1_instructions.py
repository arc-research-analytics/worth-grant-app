...
st.markdown(f'''
    <p style="font-size: 23px; font-weight: 200; text-align: left;">
        ...
        Keep the former file for your records, but return the latter file to Will Wright at <a href="mailto:wwright@atlantaregional.org">wwright@atlantaregional.org</a>.
    </p>
''', unsafe_allow_html=True)
